		...
		<div class="row">
			...
			<div class="col-md-5 offset-md-4">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-3 text-center">Add Video</p>
						...
						<form action="../addVideo" method="post"
							...
							<div class="mb-3">
								<label class="form-label">Video Name</label> <input
									type="text" required name="videoname" class="form-control">
							</div>
							
							<div class="mb-3">
								<label class="form-label">Video path</label> <input
									type="text" required name="videopath" class="form-control">
							</div>
